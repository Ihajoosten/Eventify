...
{
    public class InfraLayerFixture : IDisposable
    {
        private readonly DbContextOptions<TestDbContext> _options;
        public TestDbContext Context { get; private set; }

        public InfraLayerFixture()
        {
            // Initialize the database context with the same connection string
            _options = new DbContextOptionsBuilder<TestDbContext>()
                .UseNpgsql("Host=ep-soft-sunset-52153316.eu-central-1.aws.neon.tech;Port=5432;Database=eventify1-test;Username=Ihajoosten;Password=vaIM1win0Ucs;Integrated Security=true;")
                .Options;
